--[[
    ...
    Credits:
        Original Libary (Venyx Library) - Denosaur @ v3rmillion.net / Dino#3523 @ discord.gg
        Name Idea - SH4D0W1160 @ v3rmillion.net / Umbreus#6666 @ discord.gg
...
pcall(function()
    ...
    if getgenv().Sinister_Loaded and getgenv().Sinister then
        getgenv().Sinister:Destroy()
    end

    -- Set Globals --
    getgenv().Sinister_Loaded = true
    getgenv().Sinister_Info  = {}
    getgenv().Sinister = nil
end)
	...
	function Utility:Create(instance, properties, children)
		...
		for i, v in pairs(properties or {}) do
			...
			if typeof(v) == "Color3" then -- save for theme changer later
				local theme = Utility:Find(ColorScheme, v)
...
do
	...
	function Library.new(Title)
		local container = Utility:Create("ScreenGui", {
			Name = Title,
			Parent = Services.RunService:IsStudio() and LocalPlayer.PlayerGui or Services.CoreGui
		}, {
			Utility:Create("ImageLabel", {
				...
				Utility:Create("ImageLabel", {
					...
					ImageColor3 = ColorScheme.DarkContrast,
					ScaleType = Enum.ScaleType.Slice,
					SliceCenter = Rect.new(4, 4, 296, 296)
				}, {
				...
				Utility:Create("ImageLabel", {
					...
					ImageColor3 = ColorScheme.Accent,
					ScaleType = Enum.ScaleType.Slice,
					SliceCenter = Rect.new(4, 4, 296, 296)
				}, {
					Utility:Create("TextLabel", { -- title
						...
						Text = Title or "Title",
						TextColor3 = ColorScheme.TextColor,
						TextSize = 14,
	...
	function page.new(Library, title, icon)
		local button = Utility:Create("TextButton", {
			...
			icon and Utility:Create("ImageLabel", {
				...
				ImageColor3 = ColorScheme.TextColor,
		...
		local container = Utility:Create("ScrollingFrame", {
			...
			ScrollBarImageColor3 = ColorScheme.DarkContrast,
			Visible = false
		}, {
			Utility:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder,
	...
	function section.new(page, title)
		local container = Utility:Create("ImageLabel", {
			...
			ImageColor3 = ColorScheme.LightContrast,
			ScaleType = Enum.ScaleType.Slice,
			SliceCenter = Rect.new(4, 4, 296, 296),
			ClipsDescendants = true
		}, {
		...
		local tab = Utility:Create("ImageLabel", {
			...
			Utility:Create("Frame", {
				...
				Utility:Create("ImageButton", {
					Name = "Canvas",
					BackgroundTransparency = 1,
					BorderColor3 = ColorScheme.LightContrast,
					...
					Utility:Create("ImageLabel", {
						Name = "Cursor",
						BackgroundColor3 = ColorScheme.TextColor,
						AnchorPoint = Vector2.new(0.5, 0.5),
				...
				Utility:Create("Frame", {
					...
					Utility:Create("ImageLabel", {
						...
						Utility:Create("TextBox", {
							...
							ZIndex = 2,
							Font = Enum.Font.Gotham,
							PlaceholderColor3 = ColorScheme.DarkContrast,
							Text = "255",
							TextColor3 = ColorScheme.TextColor,
							TextSize = 10.000
						})
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		for i, value in pairs(list or {}) do
			...
			button.MouseButton1Click:Connect(function()
                local Success, Error = pcall(callback or function() end, value, function(...)
